...
class CapitalT(object):
    ...
    def clone(self):
        ...
        lttr_thickness = self.h_rect.get_height()
        temp = CapitalT(intersection, width, height, lttr_thickness)
        temp.set_colors(self.h_rect.fill_color, self.h_rect.outline_color)
        return temp
        # --------------------------------------------------------------
        # Done: 7.
        #   READ the above specification, including the Example.
